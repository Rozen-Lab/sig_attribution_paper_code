...
dataset_name <- "DBS"
input_dir <- "analysis/raw_output/DBS/msa_opt/syn/input"
data_identifier <- "syn_data"
output_home <- "analysis/raw_output/DBS/msa_opt/syn/output"
bash_script_home <- "analysis/code/DBS/msa_opt/"
...
# for more details
msa_nextflow_file <- 
  "common_code/MSA/run_auto_optimised_analysis_DBS.nf"
project_dir <- getwd()
