...
DATA_DIR=analysis/raw_output/DBS/msa_default/syn/input/Stomach-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/DBS/msa_default/syn/output/Stomach-AdenoCA/non_msi/raw
TOOL=conda
TYPE=DBS
