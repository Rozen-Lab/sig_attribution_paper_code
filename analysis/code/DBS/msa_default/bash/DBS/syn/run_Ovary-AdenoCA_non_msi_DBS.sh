...
DATA_DIR=analysis/raw_output/DBS/msa_default/syn/input/Ovary-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/DBS/msa_default/syn/output/Ovary-AdenoCA/non_msi/raw
TOOL=conda
TYPE=DBS
