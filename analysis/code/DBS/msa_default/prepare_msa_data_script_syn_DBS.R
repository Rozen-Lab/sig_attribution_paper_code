...
dataset_name <- "DBS"
input_dir <- "analysis/raw_output/DBS/msa_default/syn/input"
data_identifier <- "syn_data"
output_home <- "analysis/raw_output/DBS/msa_default/syn/output"
bash_script_home <- "analysis/code/DBS/msa_default"
