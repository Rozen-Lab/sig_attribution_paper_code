...
PROJECT_DIR="."
DIR1=analysis/code/DBS/msa_default
DIR2=analysis/code/DBS/msa_thresholdx10
DIR3=analysis/code/DBS/msa_thresholdx100
DIR4=analysis/code/DBS/msa_thresholdx1000
