...
DATA_DIR=analysis/raw_output/DBS/msa_thresholdx100/syn/input/Ovary-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/DBS/msa_thresholdx100/syn/output/Ovary-AdenoCA/non_msi/raw
TOOL=conda
TYPE=DBS
