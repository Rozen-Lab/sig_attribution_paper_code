...
DATA_DIR=analysis/raw_output/DBS/msa_thresholdx100/syn/input/Liver-HCC/msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/DBS/msa_thresholdx100/syn/output/Liver-HCC/msi/raw
TOOL=conda
TYPE=DBS
