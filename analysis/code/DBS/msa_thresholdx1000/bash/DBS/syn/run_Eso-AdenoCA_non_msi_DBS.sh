...
DATA_DIR=analysis/raw_output/DBS/msa_thresholdx1000/syn/input/Eso-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/DBS/msa_thresholdx1000/syn/output/Eso-AdenoCA/non_msi/raw
TOOL=conda
TYPE=DBS
