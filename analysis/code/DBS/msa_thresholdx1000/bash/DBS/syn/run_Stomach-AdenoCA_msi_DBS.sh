...
DATA_DIR=analysis/raw_output/DBS/msa_thresholdx1000/syn/input/Stomach-AdenoCA/msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/DBS/msa_thresholdx1000/syn/output/Stomach-AdenoCA/msi/raw
TOOL=conda
TYPE=DBS
