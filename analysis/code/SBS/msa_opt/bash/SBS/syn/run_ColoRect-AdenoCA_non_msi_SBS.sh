...
MSA_NF_FILE=common_code/MSA/run_auto_optimised_analysis_SBS.nf
DATA_DIR=analysis/raw_output/SBS/msa_opt/syn/input/ColoRect-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_opt/syn/output/ColoRect-AdenoCA/non_msi/raw
TOOL=conda
TYPE=SBS
