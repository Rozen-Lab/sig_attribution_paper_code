...
DATA_DIR=analysis/raw_output/SBS/msa_opt/syn/input/Breast-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_opt/syn/output/Breast-AdenoCA/non_msi/raw
TOOL=conda
TYPE=SBS
