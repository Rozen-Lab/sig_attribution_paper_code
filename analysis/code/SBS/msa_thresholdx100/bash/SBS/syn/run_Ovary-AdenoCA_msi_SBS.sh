...
DATA_DIR=analysis/raw_output/SBS/msa_thresholdx100/syn/input/Ovary-AdenoCA/msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_thresholdx100/syn/output/Ovary-AdenoCA/msi/raw
TOOL=conda
TYPE=SBS
