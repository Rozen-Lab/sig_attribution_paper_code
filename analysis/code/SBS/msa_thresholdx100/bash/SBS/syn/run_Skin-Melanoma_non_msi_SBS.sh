...
DATA_DIR=analysis/raw_output/SBS/msa_thresholdx100/syn/input/Skin-Melanoma/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_thresholdx100/syn/output/Skin-Melanoma/non_msi/raw
TOOL=conda
TYPE=SBS
