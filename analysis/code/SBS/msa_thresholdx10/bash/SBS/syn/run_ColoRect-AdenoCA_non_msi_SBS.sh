...
MSA_NF_FILE=common_code/MSA/run_auto_optimised_analysis_thresholdx10.nf
DATA_DIR=analysis/raw_output/SBS/msa_thresholdx10/syn/input/ColoRect-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_thresholdx10/syn/output/ColoRect-AdenoCA/non_msi/raw
TOOL=conda
TYPE=SBS
