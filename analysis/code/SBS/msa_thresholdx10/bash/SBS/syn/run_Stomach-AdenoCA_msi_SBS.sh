...
DATA_DIR=analysis/raw_output/SBS/msa_thresholdx10/syn/input/Stomach-AdenoCA/msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_thresholdx10/syn/output/Stomach-AdenoCA/msi/raw
TOOL=conda
TYPE=SBS
