...
DATA_DIR=analysis/raw_output/SBS/msa_thresholdx1000/syn/input/Kidney-RCC/msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_thresholdx1000/syn/output/Kidney-RCC/msi/raw
TOOL=conda
TYPE=SBS
