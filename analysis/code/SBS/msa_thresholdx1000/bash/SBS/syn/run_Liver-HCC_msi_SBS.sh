...
DATA_DIR=analysis/raw_output/SBS/msa_thresholdx1000/syn/input/Liver-HCC/msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_thresholdx1000/syn/output/Liver-HCC/msi/raw
TOOL=conda
TYPE=SBS
