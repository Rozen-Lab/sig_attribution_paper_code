...
DATA_DIR=analysis/raw_output/SBS/msa_thresholdx1000/syn/input/ColoRect-AdenoCA/msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_thresholdx1000/syn/output/ColoRect-AdenoCA/msi/raw
TOOL=conda
TYPE=SBS
