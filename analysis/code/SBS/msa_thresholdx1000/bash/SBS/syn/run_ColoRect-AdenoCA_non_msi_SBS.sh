...
MSA_NF_FILE=common_code/MSA/run_auto_optimised_analysis_thresholdx1000.nf
DATA_DIR=analysis/raw_output/SBS/msa_thresholdx1000/syn/input/ColoRect-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_thresholdx1000/syn/output/ColoRect-AdenoCA/non_msi/raw
TOOL=conda
TYPE=SBS
