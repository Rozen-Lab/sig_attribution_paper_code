...
DATA_DIR=analysis/raw_output/ID/msa_thresholdx1000/syn/input/Breast-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/ID/msa_thresholdx1000/syn/output/Breast-AdenoCA/non_msi/raw
TOOL=conda
TYPE=ID
