...
DATA_DIR=analysis/raw_output/ID/msa_thresholdx10/syn/input/Lung-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/ID/msa_thresholdx10/syn/output/Lung-AdenoCA/non_msi/raw
TOOL=conda
TYPE=ID
