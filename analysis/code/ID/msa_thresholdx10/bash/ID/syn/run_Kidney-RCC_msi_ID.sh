...
DATA_DIR=analysis/raw_output/ID/msa_thresholdx10/syn/input/Kidney-RCC/msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/ID/msa_thresholdx10/syn/output/Kidney-RCC/msi/raw
TOOL=conda
TYPE=ID
