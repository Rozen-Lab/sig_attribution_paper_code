...
DATA_DIR=analysis/raw_output/ID/msa_thresholdx10/syn/input/Skin-Melanoma/msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/ID/msa_thresholdx10/syn/output/Skin-Melanoma/msi/raw
TOOL=conda
TYPE=ID
