...
DATA_DIR=analysis/raw_output/ID/msa_thresholdx10/syn/input/Kidney-RCC/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/ID/msa_thresholdx10/syn/output/Kidney-RCC/non_msi/raw
TOOL=conda
TYPE=ID
