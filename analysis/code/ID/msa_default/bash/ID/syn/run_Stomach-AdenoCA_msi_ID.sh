...
DATA_DIR=analysis/raw_output/ID/msa_default/syn/input/Stomach-AdenoCA/msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/ID/msa_default/syn/output/Stomach-AdenoCA/msi/raw
TOOL=conda
TYPE=ID
