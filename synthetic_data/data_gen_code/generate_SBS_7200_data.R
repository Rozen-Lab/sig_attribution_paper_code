...
scale_factors <- n_samples_per_type / num_samples_total
...
# cancer type
num_samples_no_msi_pole_scaled <- rep(n_samples_per_type, length(cancer_types))
...
# Only generate n_samples_per_type synthetic tumors for kidney. Scale the
# original number of tumors in real exposure accordingly
kidney_scale_factor <- n_samples_per_type / num_kidney_samples_total
...
output_dir_sbs96_no_msi_pole <-
  "./synthetic_data/SBS_7200/intermed_results/PCAWG.SBS96.syn.exposures.no.msi"
output_dir_sbs96_msi <-
  "./synthetic_data/SBS_7200/intermed_results/PCAWG.SBS96.syn.exposures.msi"
output_dir_sbs96_pole <-
  "./synthetic_data/SBS_7200/intermed_results/PCAWG.SBS96.syn.exposures.pole"
...
output_dir_kidney_sbs96_no_msi <-
  "./synthetic_data/SBS_7200/intermed_results/kidney.SBS96.syn.exposures.no.msi"
output_dir_kidney_sbs96_msi <-
  "./synthetic_data/SBS_7200/intermed_results/kidney.SBS96.syn.exposures.msi"
...
output_dir_sbs96 <-
  "./synthetic_data/SBS_7200/intermed_results/SBS96.syn.exposures.no.noise"
output_dir_sbs96_nb_size_selected <-
  "./synthetic_data/SBS_7200/intermed_results/SBS96.syn.exposures.noisy.neg.binom.size.selected"
